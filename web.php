...
use App\Http\Controllers\SupervisosController;
use App\Http\Controllers\SupervisorController;
use App\Http\Controllers\SupervCreateController;

Route::get('/superv-create', [SupervCreateController::class, 'create'])->name('superv.create');
Route::post('/superv-create', [SupervCreateController::class, 'store'])->name('superv.store');



Route::post('/admin_dashboard', [AdminDashboardController::class, 'index'])->name('admin.dashboard');
Route::get('/admin_dashboard', [AdminDashboardController::class, 'index'])->name('admin.dashboard');

Route::post('/assignsupervisor', [SupervisorController::class, 'assignSupervisor'])->name('assign.supervisor');


Route::post('/supervisos/store', [SupervisosController::class, 'store'])->name('supervisos.store');
